...
This is a new one-cycle, 15-block supplement after the earlier three-cycle sweep was stopped. No extension, fork or Jacobian job is part of this run. The first two beta groups reuse five previously completed parents each; the later beta groups used one zhai_p L40S GPU sequentially. Seeds are 202, 303, 404, 505 and 606. The confirmation audit remains closed.
...
| 0.0015 | Five new parent-15 trajectories and O analysis verified ([index](C4_Parent15_O_l07_b00015_README.md)) | [PDF](C4_Parent15_O_l07_b00015_EN.pdf) | [CSV](C4_Parent15_O_l07_b00015_O_steps.csv) | [CSV](C4_Parent15_O_l07_b00015_O_blocks.csv) | [CSV](C4_Parent15_O_l07_b00015_O_cells.csv) | [JSON](C4_Parent15_O_l07_b00015_source_manifest.json) |

| 0.002 | Five new parent-15 trajectories and O analysis verified ([index](C4_Parent15_O_l07_b0002_README.md)) | [PDF](C4_Parent15_O_l07_b0002_EN.pdf) | [CSV](C4_Parent15_O_l07_b0002_O_steps.csv) | [CSV](C4_Parent15_O_l07_b0002_O_blocks.csv) | [CSV](C4_Parent15_O_l07_b0002_O_cells.csv) | [JSON](C4_Parent15_O_l07_b0002_source_manifest.json) |

All four beta groups are complete. [Analysis and run code](C4_Parent15_O_Code_20260924.tar.gz). Bulk batch tapes and checkpoints remain on Sapelo at `/scratch/yz54720/RSI2RSD/C4/`. The analysis checks hashes of each consumed step archive, update log and block summary, then reconciles selected CE with original logs. This is narrower than full checkpoint-manifest verification. The reports do not claim sustained deterioration or an identified Jacobian.
