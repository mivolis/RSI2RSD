...
For the Yingchuan 40-cell sequential extension, see [the run and report guide](C4_Yingchuan_20260923_README.md) and [the code archive](C4_Yingchuan_Code_20260923.tar.gz). Checkpoint 1 (lambda=0.4, beta=0.0005) is complete: [English PDF](C4_Yingchuan_Pair01_l04_b00005_EN.pdf), [evidence and checksums](C4_Yingchuan_Pair01_README.md). Each later five-seed pair receives an audited English PDF before the next beta.
