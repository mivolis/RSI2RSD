...
For the Yingchuan 40-cell sequential extension, see [the run and report guide](C4_Yingchuan_20260923_README.md) and [the code archive](C4_Yingchuan_Code_20260923.tar.gz). Checkpoint 1 (lambda=0.4, beta=0.0005): [English PDF](C4_Yingchuan_Pair01_l04_b00005_EN.pdf), [evidence and checksums](C4_Yingchuan_Pair01_README.md). Checkpoint 2 (lambda=0.4, beta=0.001): [English PDF](C4_Yingchuan_Pair02_l04_b0001_EN.pdf), [evidence and checksums](C4_Yingchuan_Pair02_README.md). Checkpoint 3 (lambda=0.4, beta=0.0015): [English PDF](C4_Yingchuan_Pair03_l04_b00015_EN.pdf), [evidence and checksums](C4_Yingchuan_Pair03_README.md). Checkpoint 4 (lambda=0.4, beta=0.002): [English PDF](C4_Yingchuan_Pair04_l04_b0002_EN.pdf), [evidence and checksums](C4_Yingchuan_Pair04_README.md). Checkpoint 5 (lambda=0.7, beta=0.0005): [English PDF](C4_Yingchuan_Pair05_l07_b00005_EN.pdf), [evidence and checksums](C4_Yingchuan_Pair05_README.md). Each five-seed pair receives an audited English PDF before the next beta.
